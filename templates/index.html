...
<body>
    <div class="container">
        ...
        <img src="/static/images/Bosch.png" alt="Bosch Logo" class="logo"> <!-- Corrected path for static images -->
        ...
        <form action="/process" method="post" enctype="multipart/form-data">
            ...
            {# NEW CHANGE: Make Workon P71 file input optional #}
            <div class="form-group">
                <label for="workon_file">Upload Workon P71 Excel File (.xlsx) (Optional):</label>
                <input type="file" name="workon_file" id="workon_file" accept=".xlsx"> {# Removed 'required' #}
            </div>
            {# END NEW CHANGE #}
            {# NEW CHANGE: Add RGPA file input field (required) #}
            <div class="form-group">
                <label for="rgpa_file">Upload RGPA Excel File (.xlsx):</label>
                <input type="file" name="rgpa_file" id="rgpa_file" accept=".xlsx" required>
            </div>
            {# END NEW CHANGE #}
            {# NEW CHANGE: Add SMD file input field (optional) #}
            <div class="form-group">
    ...
    <div id="rulesModal" class="modal">
        <div class="modal-content">
            ...
            <ul>
                ...
                {# NEW CHANGE: Update Workon P71 rules for optionality and new total file count #}
                ...
                {# END NEW CHANGE #}
                {# NEW CHANGE: Add RGPA Mandatory Columns rule #}
                ...
                {# END NEW CHANGE #}
                {# NEW CHANGE: Add SMD Mandatory Columns rule #}
                ...
                {# END NEW CHANGE #}
                {# NEW CHANGE: Update processing message to include RGPA and SMD #}
                <li><strong>Processing & Upload:</strong> Upload the ESM, PISA, PM7, RGPA, (optionally Workon P71 and SMD), and Central files. Then, click on the <strong>"Process Files"</strong> button. The new updated tracker file will be automatically downloaded and will be ready for allocation.</li>
                {# END NEW CHANGE #}
